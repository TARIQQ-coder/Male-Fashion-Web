...
const Shop = () => {
  ...
  const products= [
    { name: "Piqué Biker Jacket", price: "$67.24", image: `${SalesJacket1}` },
        ...
        { name: "Dopamine Honnex Canvas", price: "$60.90", image: `${SalesShoe2}` },{ name: "Winter Hoodie", price: "$72.00", image: `${SalesHoodie}`,rating: 3 },
            { name: "Wool Hat", price: "$24.50", image: `${SalesHat}`,rating: 4 },
            { name: "Nike Max Shoe", price: "$60.90", image: `${SalesShoe1}` },
            { name: "Piqué Biker Cap", price: "$67.24", image: `${SalesCap2}` },{ name: "Ankle Boots", price: "$98.49", image: `${SalesBoot}`, tag: "SALE", rating: 4 },
                        ...
                        {/* Search */}
                            <div className="max-w-[508px] mx-auto mb-4">
                              <div className="relative">
                                ...
                                />
                                <LiaSearchSolid className="w-6 h-6 absolute top-3.5 right-4 text-[#c4baba]" />
                              </div>
                            </div>
                          ...
                          <div className={`w-full mt-8  font-semibold text-black ${openCategories ? 'border-b border-gray-300 pb-4' : ''}`}>
                            {/* Header */}
                                ...
                                >
                                  ...
                                  {openCategories ? (
                                    <ChevronUp size={21} strokeWidth={3.5} />
                                  ) : (
                                    <ChevronDown size={21} strokeWidth={3.5} />
                                  )}
                                </div>
                                ...
                                <div
                                  className={`transition-all duration-300 ease-in-out overflow-hidden pr-2 ${
                                    openCategories ? 'max-h-48 overflow-y-auto' : 'max-h-0'
                                  }`}
                                >
                      ...
                      {/* colors */}
                          <div className={`w-full -mb-4 font-semibold text-black ${openColors ? 'border-b border-gray-300 pb-4' : ''}`}>
                            ...
                            <div
                              ...
                              {openColors ? (
                                <ChevronUp size={21} strokeWidth={4} />
                              ) : (
                                <ChevronDown size={21} strokeWidth={4} />
                              )}
                            </div>
