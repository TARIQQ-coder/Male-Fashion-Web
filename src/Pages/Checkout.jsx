  ...
  return (
    <div>
                  ...
                  <div className='md:grid grid-cols-5'>
                    ...
                    <div className="max-w-4xl mx-auto px-25 bg-white col-span-3">
                      ...
                      <div className='my-6 relative'>
                          <input type="text" className='border-t-2 w-full bg-[#f5f5f5] py-4 pl-14 border-green-600 text-sm f placeholder:text-black outline-none'
                          placeholder=' Have a coupon? Click here to enter your code'/>
                          <LiaTagSolid className='w-5 h-5 absolute top-4.5 left-5'/>
                      </div>

              <h2 className="text-lg font-semibold mb-4 border-b pb-4 border-gray-300">BILLING DETAILS</h2>
        ...
        <div>
            ...
            <div>
              ...
              <div>
                ...
                <p className='text-sm font-medium'>Create an account by entering the information below. If you are a returning customer please login at the top of the page</p>
                </div>
      ...
      <div className="space-y-4 text-gray-800">
        ...
        <div className="flex justify-between text-lg">
          <span>04. Cluten free mini dozen</span>
          <span>$ 110.0</span>
        </div>
      </div>
      ...
      <div className="flex justify-between space-y-4">
        <span>Subtotal</span>
        <span className='text-red-500 font-semibold'>$750.99</span>
      </div>
